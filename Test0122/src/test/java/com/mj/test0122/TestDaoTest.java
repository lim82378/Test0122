...
public class TestDaoTest {
	...
	public void testLoginSelect() throws Exception {
		String id = "user1";
		String pw = "1";
		int count = tDao.loginSelect(id, pw);
